...
async function main() {
  const adapterKey = "iowa-city-permit-search";
  ...
  await upsertSource({
    ...
    baseUrl: "https://egov.iowa-city.org/energovprod/selfservice#/search",
  ...
  console.log(
    [
      `Iowa City permit search ingest complete.`,
      `sourceId=${result.sourceId}`,
      `permitsDiscovered=${result.discovered}`,
